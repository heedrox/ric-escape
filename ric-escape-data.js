...
exports.data = {
  ...
  items: [
    anItem('ric', 'RIC', ['rick', 'robot', 'robot ric', 'robot rick', 'rick el robot', 'ric el robot', 'robot maléfico', 'ric and moriarty', 'ric modificado', 'robot modificado'], 'Soy RIC, el Remoto Interfaz al Córtex. Gracias a mi, puedes interactuar y andar en esta nave, aunque realmente estás tendido en tu habitación. ¿Qué quieres que haga?', null, false),
    ...
    anItem('pasnor-televisor', 'Televisores', ['televisores del pasillo norte', 'televisor', 'televisión', 'televisor del pasillo', 'televisor del pasillo norte'], 'Son televisores que muestran números. No sé interpretarlos. ¿Qué hago?', 'pasillo-norte', false),
    ...
    anItem('pascen-televisor', 'Televisores', ['televisor', 'televisión', 'televisor del pasillo', 'televisor del pasillo norte'], 'Son televisores que muestran números. No sé interpretarlos. ¿Qué hago?', 'pasillo-central', false),
    ...
    anItem('passur-televisor', 'Televisores', ['televisor', 'televisión', 'televisor del pasillo', 'televisor del pasillo norte'], 'Son televisores que muestran números. No sé interpretarlos. ¿Qué hago?', 'pasillo-sur', false),
    ...
    anItem('biblio-libroric', 'Libro Modelos RIC', ['libros sobre modelos ric', 'modelos ric', 'modelos rick', 'libro modelos rick', 'libro sobre modelo ric', 'libro modelo ric', 'libro modelo rick', 'libro modelo rick'], 'Es el libro de título "Modelos RIC". Di "Usar libro Modelos RIC" si quieres que te lo lea. ¿Qué hago?', 'biblioteca', false),
