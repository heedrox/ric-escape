...
exports.data = {
  sentences: {
    ...
    bye: 'Ok. It will be a pleasure to die with you. Bye. ',
    'end-timeover': 'There is no time left. We will die. It has been a pleasure to work with you. See you in another life, brother. ',
  },
  init: {
    roomId: 'sala-mandos',
    welcome: [
      'Hello! I am RIC. What do you want me to do?',
      'So you are awake? You should not be. Let me find out what happened. I am RIC, your Remote Interface to Consciousness. Wait. You cannot see nor walk. You are slept in your room. I see that a failure in the system woke you up. Well, I guess nothing matters now. What do you want me to do?',
  ...
  rooms: [
    ...
    aRoom('habitacion-108', 'Compartment number 108', ['Compartment 108', 'room 108', 'room number 108', '108 compartment', '108 room'], 'I am at the compartment number 108, your room. I can see you sleeping on the bed, a bedside table, and a picture on the wall. What next?'),
  ],
  map: {
  ...
  items: [
    anItem('ric', 'RIC', ['rick', 'robot', 'robot ric', 'robot rick', 'rick the robot', 'ric the robot', 'rick el robot', 'ric el robot', 'robot maléfico', 'ric and moriarty', 'ric modificado', 'robot modificado'], 'I am RIC, your Remote Interface to Consciousness. Through me you can interact with this ship, while you are laying on your bed. What next?', null, false),
    anItem('sala-mandos-ventanas', 'windows', ['window', 'window to the outside', 'outside windows', 'windows to outside', 'windows to the outside'], 'These are the windows to the ouside. You can see planets and stars from here, and one of those stars is really close. What next?', 'sala-mandos', false),
    ...
    anItem('pasnor-televisor', 'TVs', ['televisions', 'TV', 'television'], 'There is a television that shows numbers. I do not know how to read it, but I do not think it is important. What next?', 'pasillo-norte', false),
    ...
    anItem('pascen-televisor', 'TVs', ['televisions', 'TV', 'television'], 'There is a television that shows numbers. I do not know how to read it, but I do not think it is important. What next?', 'pasillo-central', false),
    ...
    anItem('passur-televisor', 'TVs', ['televisions', 'TV', 'television'], 'There is a television that shows numbers. I do not know how to read it, but I do not think it is important. What next?', 'pasillo-sur', false),
